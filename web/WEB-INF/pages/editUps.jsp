...
<div class ="container">
    ...
    <form  action="/updateUps" name="form" &lt;%&ndash;method ="POST"&ndash;%&gt;>
        <div class="form-group">
            <label for="id"> Id UPS</label>
            <input type="input" name="id" id="id" readonly="readonly" value="${ups.id}"class="form-control">
        </div>
    ...
    <br>
    <br>
    <a  href="<c:url value='/ups'/>">Назад к списку</a>
    <%-- <ul>

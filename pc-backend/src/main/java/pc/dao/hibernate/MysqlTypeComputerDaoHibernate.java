...
public class MysqlTypeComputerDaoHibernate implements TypeComputerDao { 
	...
	public List<TypeComputer> readAll() {
		...
		return session.createQuery("from TypeComputer order by idTypeComputer").list();
	}
	@Override
	@Transactional
	public OperationStatus update(TypeComputer o) {
		Session session = this.sessionFactory.getCurrentSession();
		try {
	...
	@Override
	@Transactional
	public OperationStatus create(TypeComputer o) {
		Session session = this.sessionFactory.getCurrentSession();
		try {
			System.out.println(o.getClass()+ " updating");
			session.save(o);
	...
	public void delete(Integer k) {
		...
		TypeComputer o = new TypeComputer();
		o.setIdTypeComputer(k);

	...
	<div class="wrapper">
		<div class="inner-wrapper">
			...
			<div class="center pane">
				...
				<div class="inner">
					<div class="top">
                      <h4>Источники бесперебойного питания</h4>
					</div>
					<div class="bottom">
						<a class="newPos"><span class="glyphicon glyphicon-asterisk"></span>&nbsp;Новый ИБС</a><br>
						...
						<table id="mtab" class="table table-striped">
							<thead>
								<tr>
									...
									<th class="col-xs-2">Инв. номер</th>
							...
							<tbody>
								...
								<c:forEach items="${upss}" var="ups" varStatus="st">

									<tr id="id${ups.idUps}">
										<td class="myIndex" hidden="true">${st.getIndex()+1}</td>
										<td class="idUps">${ups.idUps}</td>
										<td class="invNumber">${ups.invNumber}</td>
										<td class="model">${ups.model}</td>
...
<div id="editDialog" title="Редактирование источника бесп. питания" class="dialogWindow" hidden=true>
...
<div id="newDialog" title="Новый источник бесп. питания" class="dialogWindow" hidden=true>
	<table>
			<tr><td>Инв. номер</td><td><input type="text" id="invNumber" name="invNumber"></td></tr>
			<tr><td>Модель</td><td><input type="text" id="model" name="model"></td></tr>
	</table><br>
...
<div id="deleteDialog" title="Удаление источника бесп. питания" class="dialogWindow" hidden=true>

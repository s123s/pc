		...
		<div class="inner-wrapper">
			...
			<div class="center pane">
				...
				<div class="inner">
					...
					<div class="bottom">
						<a class="newPos"><span class="glyphicon glyphicon-asterisk"></span>&nbsp;Новая ОС</a><br>
						...
						<table id="mtab" class="table table-striped">
							...
							<tbody>
								...
								<c:forEach items="${oss}" var="os" varStatus="st">

									<tr id="id${os.idOs}">
										<td class="myIndex" hidden="true">${st.getIndex()+1}</td>
										<td class="idOs">${os.idOs}</td>
										<td class="model">${os.name}</td>
...
<div id="editDialog" title="Редактирование опер. системы" class="dialogWindow" hidden=true>
	<form id="editDialogForm" action="" method="post">
	  <table>
			...
			<tr><td>Название</td><td><input type="text" id="name" name="name"></td></tr>
	  </table><br>
	</form>
	<button id="editDialogSave" class="ui-button ui-widget ui-corner-all">Сохранить</button>
</div>

<div id="newDialog" title="Новая операц. система" class="dialogWindow" hidden=true>
	<table>
			<tr><td>Название</td><td><input type="text" id="name" name="name"></td></tr>
	</table><br>
...
<div id="deleteDialog" title="Удаление операц. системы" class="dialogWindow" hidden=true>

		...
		<div class="inner-wrapper">
			...
			<div class="center pane">
				...
				<div class="inner">
					...
					<div class="bottom">
						<a class="newPos"><span class="glyphicon glyphicon-asterisk"></span>&nbsp;Новый пользователь</a><br>
						...
						<table id="mtab" class="table table-striped">
							<thead>
								<tr>
									...
									<th class="col-xs-2">Почтовый адрес</th>
...
<div id="editDialog" title="Редактирование пользователя" class="dialogWindow" hidden=true>
	<form id="editDialogForm" action="" method="post">
	  <table>
			...
			<tr><td>Должность</td><td><input type="text" id="position" name="position"></td></tr>
			<tr><td>ФИО</td><td><input type="text" id="name" name="name"></td></tr>
			<tr><td>Логин</td><td><input type="text" id="login" name="login"></td></tr>
			<tr><td>Почтовый адрес</td><td><input type="text" id="mail" name="mail"></td></tr>
...
<div id="newDialog" title="Новый пользователь" class="dialogWindow" hidden=true>
	<table>
			<tr><td>Должность</td><td><input type="text" id="position" name="position"></td></tr>
			<tr><td>ФИО</td><td><input type="text" id="name" name="name"></td></tr>
			<tr><td>Логин</td><td><input type="text" id="login" name="login"></td></tr>
...
<div id="deleteDialog" title="Удаление пользователя" class="dialogWindow" hidden=true>
